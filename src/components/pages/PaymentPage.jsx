    ...
    <div className="pb-20">
      ...
      <div className="p-4 space-y-6">
        ...
        <button
          ...
          disabled={!screenshot}
          className="w-full bg-success text-white py-4 rounded-lg font-semibold hover:bg-green-600 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
        >
          Submit Order
        </button>
      </div>
